...
const builtinTransactionMappingBase: FieldMappingDefinition = {
  ...
  fields: [
    ...
    field("fulfillment", ["fulfillment", "fulfilment", "Versand", "cumplimiento", "Gestione", "フルフィルメント", "traitement", "realizacja", "gestión logística", "expédition", "leverans", "gönderim"]),
    ...
    field("product_sales_tax", ["product sales tax", "Produktumsatzsteuer", "imposta sulle vendite dei prodotti", "Taxes sur la vente des produits", "impuesto de ventas de productos", "pobrany podatek od sprzedaży", "商品の売上税"]),
    field("shipping_credits", ["shipping credits", "postage credits", "Gutschrift für Versandkosten", "Accrediti per le spedizioni", "crédits d'expédition", "crédits d’expédition", "noty kredytowe za wysyłkę", "fraktkrediter", "Verzendtegoeden", "créditos de envío", "abonos de envío", "kargo kredileri", "配送料"]),
    field("shipping_credits_tax", ["shipping credits tax", "Steuer auf Versandgutschrift", "imposta accrediti per le spedizioni", "taxe sur les crédits d’expédition", "impuesto de abono de envío", "impuestos por abonos de envío", "配送料の税金"]),
    field("gift_wrap_credits", ["gift wrap credits", "Gutschrift für Geschenkverpackung", "Accrediti per confezioni regalo", "crédits sur l'emballage cadeau", "crédits d’emballage-cadeau", "krediter för presentinslagning", "kredietpunten cadeauverpakking", "créditos por envoltorio de regalo", "abonos de envoltorio para regalo", "ギフト包装手数料"]),
    field("gift_wrap_credits_tax", ["gift wrap credits tax", "giftwrap credits tax", "Steuer auf Geschenkverpackungsgutschriften", "imposta sui crediti confezione regalo", "Taxes sur les crédits cadeaux", "impuesto de créditos de envoltura", "impuestos por abonos de envoltorio para regalo", "ギフト包装クレジットの税金"]),
    ...
    field("promotional_rebates", ["promotional rebates", "Rabatte aus Werbeaktionen", "Sconti promozionali", "Rabais promotionnels", "Total des réductions", "rabaty promocyjne", "kampanjrabatter", "promotiekortingen", "descuentos promocionales", "devoluciones promocionales", "promosyon indirimleri", "プロモーション割引額"]),
    field("promotional_rebates_tax", ["promotional rebates tax", "Steuer auf Aktionsrabatte", "imposta sugli sconti promozionali", "Taxes sur les remises promotionnelles", "impuesto de reembolsos promocionales", "impuestos de descuentos por promociones", "プロモーション割引の税金"]),
    field("marketplace_withheld_tax", ["marketplace withheld tax", "Einbehaltene Steuer auf Marketplace", "trattenuta IVA del marketplace", "Taxes retenues sur le site de vente", "Podatek od transakcji Marketplace Facilitator", "Inkasserad moms", "impuesto de retenciones en la plataforma", "impuesto retenido en el sitio web", "源泉徴収税を伴うマーケットプレイス"]),
    ...
    field("fba_fees", ["fba fees", "fulfilment by amazon fees", "Gebühren zu Versand durch Amazon", "Costi del servizio Logistica di Amazon", "Frais Expédié par Amazon", "Frais pour le service Expédié par Amazon", "opłaty za fba", "fba-avgifter", "fba-vergoedingen", "tarifas fba", "tarifas de Logística de Amazon", "Amazon Lojistik ücretleri", "FBA 手数料"], true),
